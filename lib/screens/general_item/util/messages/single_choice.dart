...
//
//   SingleChoiceWidget({required this.item, required this.giViewModel, Key? key})
//       : super(key: key);
//
//   @override
...
//         AppConfig()
//             .analytics
//             ?.logEvent(name: "single_choice_submit", parameters: {
//           'run': widget.giViewModel.run?.runId??-1,
