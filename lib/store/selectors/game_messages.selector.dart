...
final Selector<AppState, bool> isSyncingMessages = createSelector1(gameStateFeature, (GamesState state) {
...
final Selector<AppState, Color> itemColor = createSelector3(gameStateFeature, currentItemId, currentGameThemeColor,
    (GamesState state, int? itemId, Color defaultColor) {
