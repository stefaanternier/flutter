...
class CustomTheme {
  ...
  CustomTheme({
    ...
    this.cardTitleStyle = const TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),
    this.cardContentStyle =  const TextStyle(color: const Color(0xff485460), fontSize: 16, fontWeight: FontWeight.normal),
    this.listEntryTitle =  const TextStyle(color: const Color(0xff1E272E), fontSize: 14, fontWeight: FontWeight.bold),
    this.listEntrySubTitle =  const TextStyle(color: const Color(0xff485460), fontSize: 14, fontWeight: FontWeight.normal),
    this.listEntryEndOfLine=  const TextStyle(color: const Color(0xffA0ABB5), fontSize: 14, fontWeight: FontWeight.w300),
    this.runListEntryTitle  =  const TextStyle(color: const Color(0xff272727), fontSize: 16, fontWeight: FontWeight.bold),
